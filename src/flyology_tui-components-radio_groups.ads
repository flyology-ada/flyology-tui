...
generic
   ...
   Capacity : Positive;
package Flyology_TUI.Components.Radio_Groups is
   ...
   --  Replacement is atomic for duplicate-ID and capacity failures. The
   --  selected and focused identities survive reordering while still present.
